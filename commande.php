...
$article = null;
if (isset($_GET['id'])) {
    $article = getCommande($cnx);
}

$articles = getArticle($cnx); // Utilisez une variable `$articles` pour récupérer la liste de tous les articles
$commandes = getCommande($cnx);
$clients = getFournisseur($cnx); // Passer la connexion à la base de données comme argument

?>
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
        <form action="<?= !empty($_GET['id']) ? "model/modicommande.php" : (!empty($_GET['id']) ? "model/supcommande.php" : "model/ajoutcommande.php") ?>" method="POST">
...
?>
        <tr>
            ...
            <td><a href="model/supcommande.php?id=<?php echo $value['id']; ?>"><i class='bx bx-trash'></i></a></td>
        </tr>
<?php
    }
} 
